...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWE] = LAYOUT_2x2u(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,     KC_V,    KC_B,    LPAREN,  RPAREN , KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_EQL,
        KC_LCTL, KC_LGUI, NAV,     KC_LALT,  NAV,              KC_SPC,      KC_ENT,      KC_BSPC, NUM,     PIPE,    KC_BSLS, KC_RCTL
    ),
    [_NAV] = LAYOUT_2x2u(
